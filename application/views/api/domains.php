...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Domains</title>
        <link href="<?= base_url(); ?>assets/normal/css/bootstrap.css" rel="stylesheet" />
        <link href="<?= base_url(); ?>assets/normal/css/bootstrap-tagsinput.css" rel="stylesheet" />
        <link href="<?= base_url(); ?>assets/normal/css/bootstrap-tagsinput-typeahead.css" rel="stylesheet" />
    </head>
    <body>
        Domains
        
            <script src="<?= base_url(); ?>assets/normal/js/jquery-1.11.3.min.js"></script>
            <script src="<?= base_url(); ?>assets/normal/js/bootstrap.min.js"></script>
            <script src="<?= base_url(); ?>assets/normal/js/angular.min.js"></script>
            <script src="<?= base_url(); ?>assets/normal/js/bootstrap-tagsinput.js"></script>
            <script src="<?= base_url(); ?>assets/normal/js/bootstrap-tagsinput-angular.js"></script>
            <script src="<?= base_url(); ?>assets/normal/js/typeahead.bundle.js"></script>
            <script>
                $.ajax(
                        {
                            type: "GET",
                            dataType: "json",
                            url: 'http://thodaico.vn/api/v1/domain.list',
...
<html>
  <head>
    ...
    <script>(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');ga('create','UA-42755476-1','timschlechter.github.io');ga('send','pageview');</script>
  </head>
  <body>
    <div id="fb-root"></div>    
    <div class="jumbotron">
