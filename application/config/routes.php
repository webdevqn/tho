...
#Category
$route['api/v1/category.list'] =    'api/v1/product/category_list';
$route['api/v1/category.add'] =     'api/v1/product/category_add';
$route['api/v1/category.detail'] =  'api/v1/product/category_detail';
$route['api/v1/category.edit'] =    'api/v1/product/category_edit';
$route['api/v1/category.delete'] =  'api/v1/product/category_delete';

#Category
$route['api/v1/product.list'] =    'api/v1/product/product_list';
$route['api/v1/product.add'] =     'api/v1/product/product_add';
$route['api/v1/product.detail'] =  'api/v1/product/product_detail';
